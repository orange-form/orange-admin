...
public class SysUser {
    ...
    public interface SysUserModelMapper extends BaseModelMapper<SysUserVo, SysUser> {
        ...
        @Mapping(target = "sysDataPermUserList", expression = "java(mapToBean(sysUserVo.getSysDataPermUserList(), com.orange.demo.webadmin.upms.model.SysDataPermUser.class))")
        @Override
